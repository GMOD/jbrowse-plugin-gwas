// Compiles every `*.slang` source file in the plugin into its matching
...
// Shared Slang modules (hpmath, colorPack, etc.) live in @jbrowse/core.
const SHARED_INCLUDE = path.resolve(
  REPO_ROOT,
  'node_modules/@jbrowse/core/src/gpu/shaders',
)
